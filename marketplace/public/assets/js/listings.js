/* CyberGaming Lebanon member listings: progressive enhancement only. Everything works without this file. */
(function () {
    'use strict';
    ...
    /* Live "Buyers will pay $X" preview on the listing form. */
    ...
    if (box) {
        ...
        var update = function () {
            ...
            var tail = '(your price + ' + pctText(pct) + '% commission, rounded up to $0.50, delivery is paid by the buyer)';
            out.textContent = '';
            ...
            out.appendChild(document.createTextNode('Buyers will pay '));
