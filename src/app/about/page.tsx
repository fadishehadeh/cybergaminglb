  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="max-w-2xl mb-12">
        ...
        <p className="text-slate-600">For gamers, by gamers. Based in Lebanon.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              <li className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-brand/15 text-brand-dark text-xs font-bold flex items-center justify-center mt-0.5">&#x2713;</span>
                <div>
                  <p className="font-medium text-sm">100+ PS4 Games</p>
                  <p className="text-sm text-slate-500">Standard editions, steelbooks, deluxe &mdash; all tested and working.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-brand/15 text-brand-dark text-xs font-bold flex items-center justify-center mt-0.5">&#x2713;</span>
                <div>
                  ...
                  <p className="text-sm text-slate-500">18 rare steelbook editions including collector&apos;s items like Dark Souls III Apocalypse Edition.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-brand/15 text-brand-dark text-xs font-bold flex items-center justify-center mt-0.5">&#x2713;</span>
                <div>
                  ...
                  <p className="text-sm text-slate-500">Sell your old games for cash or swap them for something new.</p>
                </div>
              </li>
              <li className="flex gap-3">
                <span className="shrink-0 w-6 h-6 rounded-full bg-brand/15 text-brand-dark text-xs font-bold flex items-center justify-center mt-0.5">&#x2713;</span>
                <div>
                  ...
                  <p className="text-sm text-slate-500">All prices in US dollars. No surprises, no hidden fees.</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Check out our collection online. Filter by genre, price, or edition.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">Add games to your cart and place your order through WhatsApp. Quick and easy.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">We meet in person so you can inspect the games before paying in USD cash.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 p-3 rounded-lg bg-slate-100/60 hover:bg-slate-100 transition-colors"
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Follow us on Instagram</p>
                </div>
              </a>
              <a
                ...
                className="flex items-center gap-3 p-3 rounded-lg bg-slate-100/60 hover:bg-slate-100 transition-colors"
              >
                <svg className="w-5 h-5 text-brand-dark" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="bg-brand/10 border border-brand/30 rounded-xl p-6 text-center">
            <p className="text-brand-dark font-semibold mb-2">Ready to browse?</p>
            <Link
              href="/games"
              className="inline-block bg-brand text-navy font-semibold px-6 py-2.5 rounded-lg hover:bg-brand-dark transition-colors text-sm"
            >
              View All Games
            </Link>
          </div>
